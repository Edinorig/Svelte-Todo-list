...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$1, 16, 4, 365);
    			add_location(p, file$1, 17, 4, 436);
    			attr_dev(button1, "class", button1_class_value = "" + (null_to_empty(/*idx*/ ctx[1]) + " svelte-po2tyq"));
    			add_location(button1, file$1, 18, 4, 458);
    			...
    			add_location(div, file$1, 15, 0, 269);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (nameTodo === undefined && !('nameTodo' in $$props || $$self.$$.bound[$$self.$$.props['nameTodo']])) {
    			console.warn("<TodoItem> was created without expected prop 'nameTodo'");
    		}

    		if (idx === undefined && !('idx' in $$props || $$self.$$.bound[$$self.$$.props['idx']])) {
    			console.warn("<TodoItem> was created without expected prop 'idx'");
    		}

    		if (handlerDelete === undefined && !('handlerDelete' in $$props || $$self.$$.bound[$$self.$$.props['handlerDelete']])) {
    			console.warn("<TodoItem> was created without expected prop 'handlerDelete'");
    		}

    		if (handlerFinish === undefined && !('handlerFinish' in $$props || $$self.$$.bound[$$self.$$.props['handlerFinish']])) {
    			console.warn("<TodoItem> was created without expected prop 'handlerFinish'");
    		}
    	});
    ...
    function get_each_context(ctx, list, i) {
    	...
    	child_ctx[2] = list[i].idTasks;
    	child_ctx[7] = list[i].isDone;
    	child_ctx[8] = list[i].nameTask;
    	return child_ctx;
    }
    ...
    function create_if_block_1(ctx) {
    	...
    	todoitem = new TodoItem({
    			props: {
    				nameTodo: /*nameTask*/ ctx[8],
    				idx: /*idTasks*/ ctx[2],
    				handlerDelete: /*handlerDelete*/ ctx[3],
    				handlerFinish: /*handlerFinish*/ ctx[4]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*tasksArray*/ 2) todoitem_changes.nameTodo = /*nameTask*/ ctx[8];
    			if (dirty & /*tasksArray*/ 2) todoitem_changes.idx = /*idTasks*/ ctx[2];
    ...
    function create_each_block_1(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = !(/*isDone*/ ctx[7] == "checked") && create_if_block_1(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (!(/*isDone*/ ctx[7] == "checked")) {
    				if (if_block) {
    					if_block.p(ctx, dirty);

    					if (dirty & /*tasksArray*/ 2) {
    ...
    function create_each_block(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*isDone*/ ctx[7] == "checked" && create_if_block(ctx);
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let each_value_1 = /*tasksArray*/ ctx[1];
    	...
    	let each_value = /*tasksArray*/ ctx[1];
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*createTask*/ ctx[5], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*newTask*/ 1 && input.value !== /*newTask*/ ctx[0]) {
    				prop_dev(input, "value", /*newTask*/ ctx[0]);
    			}

    			if (dirty & /*tasksArray, handlerDelete, handlerFinish*/ 26) {
    				each_value_1 = /*tasksArray*/ ctx[1];
    				validate_each_argument(each_value_1);
    				let i;
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function createTask() {
    		...
    		if (!(newTask === "")) {
    			...
    			$$invalidate(1, tasksArray = [...tasksArray, taskProps]);
    			console.log(tasksArray);
    			$$invalidate(0, newTask = document.querySelector(".newTask").value = "");
    		} else {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('tasksArray' in $$props) $$invalidate(1, tasksArray = $$props.tasksArray);
    		if ('text' in $$props) text = $$props.text;
    		if ('idTasks' in $$props) $$invalidate(2, idTasks = $$props.idTasks);
    	};
    	...
    	return [newTask, tasksArray, idTasks, handlerDelete, handlerFinish, createTask];
    }
